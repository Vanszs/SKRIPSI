...
def load_model_from_dir(model_dir: Path) -> Tuple[Any, Dict[str, Any]]:
    """
    Utility to load any registered model (or Hybrid) given a directory.
    ...
    if not metadata_path.exists():
        raise FileNotFoundError(f"Missing metadata.json in {model_dir}. This pipeline strictly supports standard models with metadata.json.")
